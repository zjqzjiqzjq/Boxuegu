...
import cn.edu.gdmec.boxuegu.activity.VideoPlayActivity;
...
public class VideoListItemAdapter extends BaseAdapter {
    ...
    private void initializeViews(final VideoBean object, final ViewHolder holder, final int position, final View convertView) {
